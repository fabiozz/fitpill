...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  `altura` varchar(220) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `peso` varchar(220) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dias` varchar(220) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
